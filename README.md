# @diotoborg/corporis-voluptatum-saepe [![NPM version](https://img.shields.io/npm/v/@diotoborg/corporis-voluptatum-saepe.svg?style=flat)](https://www.npmjs.com/package/@diotoborg/corporis-voluptatum-saepe) [![NPM monthly downloads](https://img.shields.io/npm/dm/@diotoborg/corporis-voluptatum-saepe.svg?style=flat)](https://npmjs.org/package/@diotoborg/corporis-voluptatum-saepe) [![NPM total downloads](https://img.shields.io/npm/dt/@diotoborg/corporis-voluptatum-saepe.svg?style=flat)](https://npmjs.org/package/@diotoborg/corporis-voluptatum-saepe)  [![Tests](https://github.com/diotoborg/corporis-voluptatum-saepe/actions/workflows/test.yml/badge.svg)](https://github.com/diotoborg/corporis-voluptatum-saepe/actions/workflows/test.yml)
...
- [Sponsors](#sponsors)
  ...
  * [Why use @diotoborg/corporis-voluptatum-saepe?](#why-use-@diotoborg/corporis-voluptatum-saepe)
    + [Matching features](#matching-features)
  * [Switching to @diotoborg/corporis-voluptatum-saepe](#switching-to-@diotoborg/corporis-voluptatum-saepe)
...
```sh
$ npm install --save @diotoborg/corporis-voluptatum-saepe
```
...
```js
const @diotoborg/corporis-voluptatum-saepe = require('@diotoborg/corporis-voluptatum-saepe');
// @diotoborg/corporis-voluptatum-saepe(list, patterns[, options]);
```

The [main export](#@diotoborg/corporis-voluptatum-saepe) takes a list of strings and one or more glob patterns:

```js
console.log(@diotoborg/corporis-voluptatum-saepe(['foo', 'bar', 'baz', 'qux'], ['f*', 'b*'])) //=> ['foo', 'bar', 'baz']
console.log(@diotoborg/corporis-voluptatum-saepe(['foo', 'bar', 'baz', 'qux'], ['*', '!b*'])) //=> ['foo', 'qux']
```

Use [.isMatch()](#ismatch) to for boolean matching:

```js
console.log(@diotoborg/corporis-voluptatum-saepe.isMatch('foo', 'f*')) //=> true
console.log(@diotoborg/corporis-voluptatum-saepe.isMatch('foo', ['b*', 'f*'])) //=> true
```

[Switching](#switching-to-@diotoborg/corporis-voluptatum-saepe) from minimatch and multimatch is easy!

<br>

## Why use @diotoborg/corporis-voluptatum-saepe?

> @diotoborg/corporis-voluptatum-saepe is a [replacement](#switching-to-@diotoborg/corporis-voluptatum-saepe) for minimatch and multimatch
...
## Switching to @diotoborg/corporis-voluptatum-saepe

_(There is one notable difference between @diotoborg/corporis-voluptatum-saepe and minimatch in regards to how backslashes are handled. See [the notes about backslashes](#backslashes) for more information.)_

### From minimatch

Use [@diotoborg/corporis-voluptatum-saepe.isMatch()](#ismatch) instead of `minimatch()`:

```js
console.log(@diotoborg/corporis-voluptatum-saepe.isMatch('foo', 'b*')); //=> false
```

Use [@diotoborg/corporis-voluptatum-saepe.match()](#match) instead of `minimatch.match()`:

```js
console.log(@diotoborg/corporis-voluptatum-saepe.match(['foo', 'bar'], 'b*')); //=> 'bar'
```
...
```js
console.log(@diotoborg/corporis-voluptatum-saepe(['foo', 'bar', 'baz'], ['f*', '*z'])); //=> ['foo', 'baz']
```
...
```js
const mm = require('@diotoborg/corporis-voluptatum-saepe');
...
```js
var mm = require('@diotoborg/corporis-voluptatum-saepe');
...
```js
const { braces } = require('@diotoborg/corporis-voluptatum-saepe');
...
```js
@diotoborg/corporis-voluptatum-saepe(['a/b.js', 'a/c.md'], '*.js');
//=> []

@diotoborg/corporis-voluptatum-saepe(['a/b.js', 'a/c.md'], '*.js', { basename: true });
//=> ['a/b.js']
```
...
```js
const files = ['abc', 'ajz'];
console.log(@diotoborg/corporis-voluptatum-saepe(files, '[a-c]*'));
//=> ['abc', 'ajz']

console.log(@diotoborg/corporis-voluptatum-saepe(files, '[a-c]*', { bash: false }));
```
...
const regex = @diotoborg/corporis-voluptatum-saepe.makeRe('foo/{01..25}/bar', {
  expandRange(a, b) {
...
```js
const isMatch = @diotoborg/corporis-voluptatum-saepe.matcher('*', { ignore: 'f*' });
...
```js
console.log(@diotoborg/corporis-voluptatum-saepe(['a/z', 'a/b', 'a/!(z)'], 'a/!(z)'));
//=> ['a/b', 'a/!(z)']

console.log(@diotoborg/corporis-voluptatum-saepe(['a/z', 'a/b', 'a/!(z)'], 'a/!(z)', { noextglob: true }));
...
```js
@diotoborg/corporis-voluptatum-saepe(['a/b', 'a/b/c', 'a/b/c/d'], 'a/**');
//=> ['a/b', 'a/b/c', 'a/b/c/d']

@diotoborg/corporis-voluptatum-saepe(['a/b', 'a/b/c', 'a/b/c/d'], 'a/**', {noglobstar: true});
//=> ['a/b']
```
...
const isMatch = @diotoborg/corporis-voluptatum-saepe.matcher('*', { onIgnore, ignore: 'f*' });
isMatch('foo');
isMatch('bar');
isMatch('baz');
```
...
const isMatch = @diotoborg/corporis-voluptatum-saepe.matcher('**', { onMatch, posixSlashes: true });
isMatch('some\\path');
isMatch('some\\path');
isMatch('some\\path');
```
...
const isMatch = @diotoborg/corporis-voluptatum-saepe('*', { onResult, ignore: 'f*' });
isMatch('foo');
isMatch('bar');
isMatch('baz');
```
...
```js
console.log(@diotoborg/corporis-voluptatum-saepe.match(['a\\b\\c'], 'a/**'));
//=> ['a/b/c']

console.log(@diotoborg/corporis-voluptatum-saepe.match(['a\\b\\c'], { posixSlashes: false }));
//=> ['a\\b\\c']
```
...
```js
console.log(@diotoborg/corporis-voluptatum-saepe.match(['abc', 'a\\*c'], 'a\\*c'));
//=> ['a\\*c']

console.log(@diotoborg/corporis-voluptatum-saepe.match(['abc', 'a\\*c'], 'a\\*c', { unescape: true }));
//=> ['a*c']
```
...
```js
console.log(@diotoborg/corporis-voluptatum-saepe.isMatch('a1', '[[:alpha:][:digit:]]')) //=> true
console.log(@diotoborg/corporis-voluptatum-saepe.isMatch('a1', '[[:alpha:][:alpha:]]')) //=> false
```
...
However, it's suprising how many edge cases and rabbit holes there are with glob matching, and since there is no real glob specification, and @diotoborg/corporis-voluptatum-saepe is more accurate than both Bash and minimatch, there are cases where best-guesses were made for behavior. In a few cases where Bash had no answers, we used wildmatch (used by git) as a fallback.

### Backslashes

There is an important, notable difference between minimatch and @diotoborg/corporis-voluptatum-saepe _in regards to how backslashes are handled_ in glob patterns.
...
We made this decision for @diotoborg/corporis-voluptatum-saepe for a couple of reasons:
...
Note that when you pass something like `path.join('foo', '*')` to @diotoborg/corporis-voluptatum-saepe, you are creating a filepath and expecting it to still work as a glob pattern. This causes problems on windows, since the `path.sep` is `\\`.

In other words, since `\\` is reserved as an escape character in globs, on windows `path.join('foo', '*')` would result in `foo\\*`, which tells @diotoborg/corporis-voluptatum-saepe to match `*` as a literal character. This is the same behavior as bash.
...
```sh
# .makeRe star
  @diotoborg/corporis-voluptatum-saepe x 2,232,802 ops/sec ±2.34% (89 runs sampled))
  minimatch x 781,018 ops/sec ±6.74% (92 runs sampled))

# .makeRe star; dot=true
  @diotoborg/corporis-voluptatum-saepe x 1,863,453 ops/sec ±0.74% (93 runs sampled)
  minimatch x 723,105 ops/sec ±0.75% (93 runs sampled)

# .makeRe globstar
  @diotoborg/corporis-voluptatum-saepe x 1,624,179 ops/sec ±2.22% (91 runs sampled)
  minimatch x 1,117,230 ops/sec ±2.78% (86 runs sampled))

# .makeRe globstars
  @diotoborg/corporis-voluptatum-saepe x 1,658,642 ops/sec ±0.86% (92 runs sampled)
  minimatch x 741,224 ops/sec ±1.24% (89 runs sampled))

# .makeRe with leading star
  @diotoborg/corporis-voluptatum-saepe x 1,525,014 ops/sec ±1.63% (90 runs sampled)
  minimatch x 561,074 ops/sec ±3.07% (89 runs sampled)

# .makeRe - braces
  @diotoborg/corporis-voluptatum-saepe x 172,478 ops/sec ±2.37% (78 runs sampled)
  minimatch x 96,087 ops/sec ±2.34% (88 runs sampled)))

# .makeRe braces - range (expanded)
  @diotoborg/corporis-voluptatum-saepe x 26,973 ops/sec ±0.84% (89 runs sampled)
  minimatch x 3,023 ops/sec ±0.99% (90 runs sampled))

# .makeRe braces - range (compiled)
  @diotoborg/corporis-voluptatum-saepe x 152,892 ops/sec ±1.67% (83 runs sampled)
  minimatch x 992 ops/sec ±3.50% (89 runs sampled)d))

# .makeRe braces - nested ranges (expanded)
  @diotoborg/corporis-voluptatum-saepe x 15,816 ops/sec ±13.05% (80 runs sampled)
  minimatch x 2,953 ops/sec ±1.64% (91 runs sampled)

# .makeRe braces - nested ranges (compiled)
  @diotoborg/corporis-voluptatum-saepe x 110,881 ops/sec ±1.85% (82 runs sampled)
  minimatch x 1,008 ops/sec ±1.51% (91 runs sampled)

# .makeRe braces - set (compiled)
  @diotoborg/corporis-voluptatum-saepe x 134,930 ops/sec ±3.54% (63 runs sampled))
  minimatch x 43,242 ops/sec ±0.60% (93 runs sampled)

# .makeRe braces - nested sets (compiled)
  @diotoborg/corporis-voluptatum-saepe x 94,455 ops/sec ±1.74% (69 runs sampled))
...
It's important to us that @diotoborg/corporis-voluptatum-saepe work consistently on all platforms. If you encounter any platform-specific matching or path related issues, please let us know (pull requests are also greatly appreciated).
...
[brackets]: https://github.com/@diotoborg/corporis-voluptatum-saepe/expand-brackets
[braces]: https://github.com/@diotoborg/corporis-voluptatum-saepe/braces
...
- [braces](https://www.npmjs.com/package/braces): Bash-like brace expansion, implemented in JavaScript. Safer than other brace expansion libs, with complete support… [more](https://github.com/@diotoborg/corporis-voluptatum-saepe/braces) | [homepage](https://github.com/@diotoborg/corporis-voluptatum-saepe/braces "Bash-like brace expansion, implemented in JavaScript. Safer than other brace expansion libs, with complete support for the Bash 4.3 braces specification, without sacrificing speed.")
- [expand-brackets](https://www.npmjs.com/package/expand-brackets): Expand POSIX bracket expressions (character classes) in glob patterns. | [homepage](https://github.com/@diotoborg/corporis-voluptatum-saepe/expand-brackets "Expand POSIX bracket expressions (character classes) in glob patterns.")
- [extglob](https://www.npmjs.com/package/extglob): Extended glob support for JavaScript. Adds (almost) the expressive power of regular expressions to glob… [more](https://github.com/@diotoborg/corporis-voluptatum-saepe/extglob) | [homepage](https://github.com/@diotoborg/corporis-voluptatum-saepe/extglob "Extended glob support for JavaScript. Adds (almost) the expressive power of regular expressions to glob patterns.")
- [fill-range](https://www.npmjs.com/package/fill-range): Fill in a range of numbers or letters, optionally passing an increment or `step` to… [more](https://github.com/jonschlinkert/fill-range) | [homepage](https://github.com/jonschlinkert/fill-range "Fill in a range of numbers or letters, optionally passing an increment or `step` to use, or create a regex-compatible range with `options.toRegex`")
- [nanomatch](https://www.npmjs.com/package/nanomatch): Fast, minimal glob matcher for node.js. Similar to @diotoborg/corporis-voluptatum-saepe, minimatch and multimatch, but complete Bash… [more](https://github.com/@diotoborg/corporis-voluptatum-saepe/nanomatch) | [homepage](https://github.com/@diotoborg/corporis-voluptatum-saepe/nanomatch "Fast, minimal glob matcher for node.js. Similar to @diotoborg/corporis-voluptatum-saepe, minimatch and multimatch, but complete Bash 4.3 wildcard support only (no support for exglobs, posix brackets or braces)")
...
[extglob]: https://github.com/@diotoborg/corporis-voluptatum-saepe/extglob
